    ...
    <div className="w-full md:w-1/2 md:ml-36 mt-6 md:mt-0">
      ...
      <div className="relative">
        ...
        <div className="sticky top-0 h-96 mb-0 pb-0 flex flex-col md:flex-row items-center justify-normal bg-sky-700">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start justify-center p-6">
            ...
            <br />
            <p className="text-white">You sit back and relax while we source and shortlist high quality potential candidates for you!</p>
          </div>
        </div>
        ...
        <div className="sticky top-0 h-96 mb-0 pb-0 flex flex-col md:flex-row items-center justify-normal bg-sky-700">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start justify-center p-6">
            <h2 className="text-5xl text-white font-bold">Get shortlisted candidates within a day</h2>
            <br />
            <p className="text-white">You get top candidates faster than ever. You hire them faster than ever. No delayed hiring for you, ever again!</p>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-sky-900 text-white py-6">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between mt-14 mb-14">
